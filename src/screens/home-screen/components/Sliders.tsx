...
const SlideCards = ({
    ...
    <VStack w={200} alignItems='center' p='4' mr='4' bg='gray.200' rounded='3xl'>
        <Text fontWeight='bold' fontSize={14}>{title}</Text>
        <Text fontWeight='bold' fontSize={14}><Text fontWeight='bold' color='green.300' fontSize={14}>$</Text>{price}</Text>
        <Image
            mt='4'
            size='xl'
            rounded='full'
        ...
        <HStack alignItems='center' justifyContent='space-between' w='100%' mt='5'>
            ...
            <TouchableOpacity>
                <View bg='white' w='40px' h='40px' alignItems='center' justifyContent='center' rounded='2xl'>

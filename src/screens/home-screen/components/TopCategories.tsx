...
import { Category, selectCategories, setPickedCategory } from '../../../store/reducers/categories/categorySlice';
    ...
    <VStack h={'110px'} alignItems="center">
      <TouchableOpacity
        ...
        style={{
          ...
          width: 90,
          height: 110,
          backgroundColor: categoryState.pickedCategory === strCategory ? colors.green[600] : 'white',
          borderRadius: 20,
          borderStyle: 'solid',

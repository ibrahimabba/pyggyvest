...
import { fetchCategoriesAsync, fetchMealCategoriesAsync } from '../../store/reducers/categories/categoryThunks';
...
export default function HomeScreen({ }: RootStackScreenProps<'HomeScreen'>) {
  ...
  return (
    <KeyboardAvoidingView backgroundColor='white' flex={1} paddingTop={StatusBar.currentHeight}>
      <ScrollView
        flex={1}
        height='100%'
